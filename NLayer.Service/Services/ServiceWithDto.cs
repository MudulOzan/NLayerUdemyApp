...
namespace NLayer.Service.Services
{
    public class ServiceWithDto<Entity, Dto> : IServiceWithDto<Entity, Dto> where Entity : BaseEntity where Dto : class
    {
        ...
        public async Task<CustomResponseDto<IEnumerable<Dto>>> AddRangedAsync(IEnumerable<Dto> dtos)
        {
            var newEntities = _mapper.Map<IEnumerable<Entity>>(dtos);

            await _repository.AddRangedAsync(newEntities);
            await _unitOfWork.CommitAsync();
        ...
        public async Task<CustomResponseDto<NoContentDto>> RemoveRangedAsync(IEnumerable<int> ids)
        {
